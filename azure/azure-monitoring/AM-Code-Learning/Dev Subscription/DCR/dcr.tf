  ...
  data_sources {
    performance_counter {
      ...
      counter_specifiers = [
        ...
        #   "Processor(*)\\% Processor Time","\\Processor(_Total)\\% Processor Time","\\LogicalDisk(_Total)\\% Free Space","\\Memory\\% Committed Bytes In Use",
        # "LogicalDisk(*)\\% Free Space","Memory\\Available Bytes","Memory(*)\\% Used Memory","Memory(*)\\% Used Swap Space"   
      ]
    ...
    x_path_queries = ["System!*[System[(EventID=41 or EventID=1074 or EventID=6006 or EventID=6008)]]"]
