resource "azurerm_monitor_scheduled_query_rules_alert_v2" "APACIL-PortMonitor-Critical" {
  name                = "Alert-AM-Prod-Subscription-ICollect-Prod-PortMonitor-Critical"
  ...
  criteria {
    query                   = <<-QUERY
     ...
     NWConnectionMonitorTestResult
      ...
      | where TestGroupName has "ICLCT-PRD-TG" 
  ...
  display_name                     = "Alert-AM-Prod-Subscription-ICollect-PortMonitor-Critical"
  enabled                          = true
