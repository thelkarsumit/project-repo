resource "azurerm_monitor_scheduled_query_rules_alert_v2" "APACIL-PortMonitor-Critical" {
  name                = "Alert-AM-Prod-Subscription-APACIL-Prod-PortMonitor-Critical"
  ...
  criteria {
    query                   = <<-QUERY
     ...
     NWConnectionMonitorTestResult
      ...
      | where TestGroupName == "APACIL-PRD-CM-001"
  ...
  display_name                     = "Alert-AM-Prod-Subscription-APACIL-PortMonitor-Critical"
  enabled                          = true
